...
function Footer() {
  ...
  return (
    <div className='bg-black text-gray-300 py-10 px-6'>
      <div className='max-w-7xl mx-auto flex lg:items-center items-start justify-center
      gap-[40px] lg:gap-[150px] flex-col lg:flex-row'>
        ...
        <div className='lg:w-[30%] md:w-[100%]'>
          <div className='text-white font-semibold mb-2'>
            ...
            <ul className='text-sm space-y-1'>
              ...
              <li className='hover:text-white cursor-pointer'
                onClick={() => navigate("/allcourses")}> AllCourses</li>
              <li className='hover:text-white cursor-pointer'
                onClick={() => navigate("/login")}>Login</li>
              <li className='hover:text-white cursor-pointer'
                onClick={() => navigate("/profile")}>My Profile</li>
            </ul>
        ...
        <div className='border-t border-gray-700 mt-10 pt-5 texxt-sm text-center text-gray-500'>
