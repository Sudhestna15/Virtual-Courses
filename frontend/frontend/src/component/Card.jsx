...
function Card({ thumbnail, title, category, price, id, reviews }) {
  ...
  const handleClick = () => {
    dispatch(setSelectedCourse({ id, title, category, price, thumbnail }))
    navigate(`/viewcourse/${id}`)
  }

  return (
    <div className='max-w-sm w-full bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300
