    ...
    <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center'>
      ...
      >
        ...
        <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
          ...
          <div className='flex md:w-[50%] 2-[70%] items-center justify-between'>
            <span
          ...
          <div className='w-[80%] flex lex items-center justify-center gap-2'>
          ...
          <div className='text-[#6f6f6f]'>already have an account
            <span className='underline underline-offset-1 cursor-pointer' onClick={() => navigate("/login")}>Login</span> </div>
        </div>

        {/* Right div */}
        <div className='md:w-[50%] w-[100%] h-[100%] rounded-r-2xl bg-black md:flex items-center justify-center flex-col hidden'>
          <img src={logo} alt="logo" className='w-30 shadow-2xl' />
          <span className='text-2xl text-white'>TRAINIX</span>
        </div>
      </form>
    </div>
  )
