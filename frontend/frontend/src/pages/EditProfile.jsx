...
function EditProfile() {
  ...
  const handleEditProfile = async () => {
    setLoading(true)
    try {
      const result = await axios.post(serverUrl + "/api/user/profile",
      ...
      <div className='bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative'>
        ...
        <form action="" className='space-y-5' onSubmit={(e) => e.preventDefault()}>
          <div className='flex flex-col items-center text-center '>
            {userData?.photoUrl ? <img src={userData?.photoUrl} className='w-24 h-24 rounded-full object-cover border-4 border-[black]' />
          ...
          <div >
            ...
            <input type="file" id='image' name='photoUrl'
          ...
          <div >
            ...
            <textarea type="text" 
              ...
              name='description'
              rows={3}
              className='w-full px-4 py-2 border border-gray-300 resize-none focus:ring-2 focus:ring-[black] rounded-md '
