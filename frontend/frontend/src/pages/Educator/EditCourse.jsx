      ...
      <div className='bg-gray-50 p-6 rounded-md'>
        ...
        <div className='space-x-2 space-y-2'>
          {!isPublished ? <button className='bg-green-100 text-green-600 px-4 py-2 rounded-md border-1'
            onClick={() => setIsPublished(prev => !prev)}>Click to Publish</button>
            : <button className='bg-red-100 text-red-600 px-4 py-2 rounded-md border-1'
              onClick={() => setIsPublished(prev => !prev)}>CLick to Unpublish</button>
        ...
        <form className='space-y-6' onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            ...
            <textarea id='des' type='text' className='w-full border px-4 py-2 h-24 rounded-md'
              placeholder='CourseDescription' onChange={(e) => setDescription(e.target.value)} value={description} />
          </div>
          ...
          <div className='flex items-center justify-start gap-[15px]'>
            <button className='bg-[#e9e8e8] hover:bg-red-200 text-black border-1 border-black cursor-pointer px-4 py-2 rounded-md'
              onClick={() => navigate("/courses")}>
              Cancel
            </button>
