...
<FaArrowLeftLong className='top-[8%] absolute left-[5%] w-[22px] h-[22px] cursor-pointer'
...
<button className='w-full bg-[black] text-white py-2 px-4 rounded-md active-bg-[#3a3a3a] transition disabled'
