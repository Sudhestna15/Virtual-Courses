...
const removeLecture=async ()=>{
 try{ const result=await axios.delete(serverUrl + `/api/course/removelecture/${lectureId}`,
    {withCredentials:true}
  )
  console.log(result.data)
  setLoading1(false)
...
<input type="text" className='w-full p-3 border border-gray-300 rounded-md text-sm 
focus:ring-2 focus:ring-[rgb(0,0,0)] focus:outline-none required'
...
<input type="file" className='w-full p-2 border border-gray-300 rounded-md file:mr-4 file:py-2 file:px-4 file:rounded-md
file:border-0 file:text-sm file:bg-gray-700 file:text-[white] hover:file-bg-gray-500 required' name="" id="" accept='video/*'
