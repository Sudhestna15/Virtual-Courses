    ...
    <div className='flex min-h-screen bg-gray-100'>
      <div className='w-[100%] min-h-screen p-4 sm:p-6 bg-gray-100 '>
        ...
        <div className='hidden md:block bg-white rounded-xl shadow p-4 overflow-x-auto'>
              ...
              {creatorCourseData?.map((course, index) => (
                ...
                <tr key={index} className='border-b hover:bg-gray-50 transition duration-200'>
                  <td className='py-3 px-4 flex items-center gap-4'>
                    {course.thumbnail ?
                      <img src={course.thumbnail} className='w-25 h-14 rounded-md object-cover' alt="" />
                      : <img src={img} className='w-25 h-14 rounded-md object-cover' alt="" />}
          ...
          <p className='text-center text-sm text-graay-400 mt-6'>A list of your recent courses.</p>
