...
import getCreatorCourses from './customHooks/getCreatorCourse.js'
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/courses" element={userData ?.role==="educator"? <Courses /> :
          <Navigate to={"/signup"} />} />
        <Route path="/createcourse" element={userData?.role === "educator" ? <CreateCourses /> :
          <Navigate to={"/signup"} />} />
        ...
        <Route path="/viewcourse/:courseId" element={userData ? <ViewCourse /> :
          <Navigate to={"/signup"} />} />
        <Route path="/viewlecture/:courseId" element={userData?.role === "educator" ? <ViewLectures /> :
          <Navigate to="/signup" />} />
